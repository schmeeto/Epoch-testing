...
_colorTitle         = "#FACC2E"; // HTML Color Code of the Title Messages (must start with '#' )
...
_shorttext         = "UKE's Arma3 Epoch Chernarus";
_posText        = [0.25,0.5,0.4];

_title2         = "Website";
_shorttext2     = "http://uke-clan.com/";
_posText2        = [0.25,0.5,0.4];

_title3            = "Teamspeak 3";
_shorttext3     = "teamspeak3.i3d.net:10213";
_posText3        = [0.25,0.5,0.4];

_title4         = "Addons";
_shorttext4     = "Ai Missions<br />Custom HUD<br />Increased Loot<br />Anti-Hack<br />Custom Buildings";
_posText4        = [0.25,0.5,0.4];

_title5         = "Basic Rules";
_shorttext5     = "No building on roads<br />No building on air fields<br />No camping static traders<br />No voice in sidechat<br />Respect admins and players!";
_posText5        = [0.25,0.5,0.4];

_title6         = "Donate";
_shorttext6     = "Donations are appreciated!<br />http://uke-clan.com/.";
